  ...
  head: () => ({
    meta: [
      ...
      { title: "Sri Gopal Bihar | Residential Plots & Homes in Odisha" },
      {
        name: "description",
        content:
          "Sri Gopal Bihar: transparent property information, site visits and direct developer communication in Odisha.",
      },
      { name: "author", content: "Sri Gopal Bihar" },
      { property: "og:title", content: "Sri Gopal Bihar | Residential Plots & Homes in Odisha" },
      {
        property: "og:description",
        content:
          "Visit the real location, review available documents and speak directly with our team.",
      },
